...
This composable is to be used on the custom components with which a Dialog plugin is invoked. It will bootstrap all the necessary communication of the component with the plugin.
